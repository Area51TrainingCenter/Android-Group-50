 ...
 */
        values.add(new BarEntry(1,13f));
        values.add(new BarEntry(2,3f));
        values.add(new BarEntry(3,5f));
        values.add(new BarEntry(4,7f));
